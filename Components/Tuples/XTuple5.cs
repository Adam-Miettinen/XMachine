...
{
	internal sealed class XTuple<T1, T2, T3, T4, T5> : XTypeComponent<Tuple<T1, T2, T3, T4, T5>>
	{
		internal XTuple() { }

		protected override void OnBuild(XType<Tuple<T1, T2, T3, T4, T5>> xType, IXReadOperation reader, XElement element,
			ObjectBuilder<Tuple<T1, T2, T3, T4, T5>> objectBuilder)
		{
			// T1
			...
			objectBuilder.AddTask(() =>
			{
				...
				{
					objectBuilder.Object = new Tuple<T1, T2, T3, T4, T5>(item1, item2, item3, item4, item5);
					return true;
				}
				return false;
			});
		...
		protected override bool OnWrite(XType<Tuple<T1, T2, T3, T4, T5>> xType, IXWriteOperation writer,
			Tuple<T1, T2, T3, T4, T5> obj, XElement element)
		{
