...
{
	internal sealed class XTuple<T1, T2, T3, T4, T5, T6, T7> : XTypeComponent<Tuple<T1, T2, T3, T4, T5, T6, T7>>
	{
		internal XTuple() { }

		protected override void OnBuild(XType<Tuple<T1, T2, T3, T4, T5, T6, T7>> xType, IXReadOperation reader, XElement element,
			ObjectBuilder<Tuple<T1, T2, T3, T4, T5, T6, T7>> objectBuilder)
		{
			// T1
			...
			reader.AddTask(this, () =>
			{
				...
				{
					objectBuilder.Object = new Tuple<T1, T2, T3, T4, T5, T6, T7>(item1, item2, item3, item4, item5, item6, item7);
					return true;
				}
				return false;
			});
		...
		protected override bool OnWrite(XType<Tuple<T1, T2, T3, T4, T5, T6, T7>> xType, IXWriteOperation writer,
			Tuple<T1, T2, T3, T4, T5, T6, T7> obj, XElement element)
		{
